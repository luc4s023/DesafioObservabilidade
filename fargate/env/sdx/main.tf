...
module "ecs_cluster" {
  source = "github.com/luc4s023/modulo_ecs_luc4s//modules/cluster"
...
module "app_container" {
  source = "github.com/luc4s023/modulo_ecs_luc4s//modules/container-definition"
...
module "ecs_service" {
  source = "github.com/luc4s023/modulo_ecs_luc4s//modules/service"
